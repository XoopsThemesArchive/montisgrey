Montisgrey Theme for Xoops2 provided to the Xoops Community by Montisarts.com
1. Extract the contents of the Themes_Folder_Files.zip to your Xoops2 Theme Folder !(preserve file the paths)!
2. Upload the montisarts2.tar.gz via the admin/templates option in Xoops2.
3. Make sure to select montisarts2 as the default TEMPLATE in admin > preferences > general. (12th Option Down)
